...
### Backlog
<!-- backlog-list:start -->
- **agentic-workflow-012** — Add a dark-mode toggle to the dashboard — `backlog/agentic-workflow-012-dashboard-dark-mode-toggle.md`
- **agentic-workflow-013** — Click a card to copy its task id to the clipboard — `backlog/agentic-workflow-013-copy-task-id-from-card.md`
<!-- backlog-list:end -->
