...
- **infrastructure-007** — Throttle the dashboard file-watcher so a burst of tree changes (e.g. a large git checkout) collapses into few tree-changed events (feature) — `backlog/infrastructure-007-dashboard-watcher-throttle-burst-changes.md`
<!-- backlog-list:end -->
