      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 26, marginBottom: 26 }}>
        <DocCard>
          ...
          <div style={{ marginTop: -4, marginBottom: -16 }}>
            <TypeRow role="Heading 1" spec="23px · 600" sample={<span style={{ fontFamily: "var(--font-ui)", fontSize: 23, fontWeight: 600, letterSpacing: "-0.01em", color: "var(--fg-1)" }}>Zero to oriented</span>} />
            <TypeRow role="Heading 2" spec="18px · 500" sample={<span style={{ fontFamily: "var(--font-ui)", fontSize: 18, fontWeight: 500, color: "var(--fg-1)" }}>Bounded contexts</span>} />
            <TypeRow role="Body" spec="14px · 400" sample={<span style={{ fontFamily: "var(--font-ui)", fontSize: 14, color: "var(--fg-1)" }}>The folder is the source of truth.</span>} />
            <TypeRow role="Body small" spec="13px · 400" sample={<span style={{ fontFamily: "var(--font-ui)", fontSize: 13, color: "var(--fg-2)" }}>Read-first lens over agent files.</span>} />
            <TypeRow role="Label" spec="11px · 600 · caps" sample={<span style={{ fontFamily: "var(--font-ui)", fontSize: 11, fontWeight: 600, letterSpacing: "0.06em", textTransform: "uppercase", color: "var(--fg-3)" }}>Workspace</span>} />
          </div>
        </DocCard>
        ...
        <DocCard>
          ...
          <div style={{ marginTop: -4, marginBottom: -16 }}>
            <TypeRow role="Prose H1" spec="27px · 600" sample={<span style={{ fontFamily: "var(--font-ui)", fontSize: 27, fontWeight: 600, letterSpacing: "-0.02em", color: "var(--fg-1)" }}>ADR-0007</span>} />
            <TypeRow role="Prose H2" spec="20px · 600" sample={<span style={{ fontFamily: "var(--font-ui)", fontSize: 20, fontWeight: 600, color: "var(--fg-1)" }}>Decision</span>} />
            <TypeRow role="Prose body" spec="15.5px · 1.72" sample={<span style={{ fontFamily: "var(--font-ui)", fontSize: 15.5, lineHeight: 1.5, color: "var(--fg-1)" }}>Writes append domain events.</span>} />
            <TypeRow role="Inline code" spec="mono · 0.86em" sample={<span><span style={{ fontFamily: "var(--font-ui)", fontSize: 15.5, color: "var(--fg-1)" }}>replay </span><code style={{ fontFamily: "var(--font-mono)", fontSize: 13, background: "var(--code-bg)", border: "1px solid var(--code-border)", borderRadius: 4, padding: "1px 6px", color: "var(--fg-1)" }}>InvoiceEvent</code></span>} />
            <TypeRow role="Link" spec="accent ochre" sample={<span style={{ fontFamily: "var(--font-ui)", fontSize: 15.5, color: "var(--accent-ochre)", borderBottom: "1px solid color-mix(in oklab, var(--accent-ochre) 40%, transparent)" }}>context map</span>} />
          </div>
        </DocCard>
      </div>
    ...
    <GuideSection index="03" title="Spacing, radii &amp; elevation"
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1.4fr 1fr", gap: 26, marginBottom: 26 }}>
        ...
        <DocCard>
          ...
          <div style={{ display: "flex", gap: 18, flexWrap: "wrap" }}>
            {[["--radius-sm", "4px", "Chips, inputs"], ["--radius-md", "8px", "Cards, drawer"], ["--radius-none", "0", "Tables, hairlines"]].map(([v, px, role]) => (
      ...
      <DocCard>
        ...
        <div style={{ display: "flex", gap: 28, flexWrap: "wrap" }}>
          {[["--shadow-sm", "Card hover"], ["--shadow-md", "Popovers"], ["--shadow-lg", "Modals"], ["--shadow-drawer", "Slide-over drawer"]].map(([v, role]) => (
...
function IconSection() {
  const ui = ["square-kanban", "library", "search", "plus", "folder", "chevron-right", "x", "copy", "square-arrow-out-up-right", "bot", "inbox", "arrow-right", "folder-git-2", "settings-2"];
  return (
...
Object.assign(window, { TypographySection, SpacingSection, IconSection });
