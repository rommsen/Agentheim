...
### Doing
<!-- doing-list:start -->
- **agentic-workflow-071** — Confetti "no @keyframes" test trips on the unrelated About-page aboutRise keyframe (bug) — `doing/agentic-workflow-071-confetti-keyframes-test-trips-on-aboutrise.md`
<!-- doing-list:end -->
